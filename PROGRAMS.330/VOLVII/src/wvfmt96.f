...
c       25 MAY 2022 - commented out write(stdout,*)'What is the input file name?'
c     
c-----
c
...
c       mxx, myy, mxy, mxz, myz and mzz components of moment tensor
c          dyne-cm
c-----
        if(ipass.eq.2)then
     ...
     5      mtensor(1)*m0,mtensor(2)*m0,mtensor(3)*m0,
     6      mtensor(4)*m0,mtensor(5)*m0,mtensor(6)*m0
    3   format('WVFMT961 ',f6.1,3f6.0,f7.2,f10.3,e10.3,
     1     2f10.3,e10.3,f6.1,6e15.7)
        call outmsg(nwaves)
        close (3)
        endif
        return
