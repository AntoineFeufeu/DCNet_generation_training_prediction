...
c                   exceed NM
c     12 JUN 2016 - removed tabs
c     17 MAY 2019 - changed line 445 from
c              real*4 per(NP), tmp(NM)
c     to       real*4 per(NM), tmp(NM)

c     20 MAY 2020 - put in a check if the numebr of periods NP
c                   would be exceeded
c
c
c
