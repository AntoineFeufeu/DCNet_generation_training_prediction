...
c-----
        ...
        character*80 outl
        character outstr*14
        data outstr/'SHALLOW96 MENU'/
        data (out(i),i=1,10)/
     1 ' 0- Display menu                        '
     1,' 1- Run Dispersion / Travel time        '
     1,' 2- Run Velocity Inversion              '
     1,'                                        '
     1,'                                        '
     1,' 5- Set Thick(0)/Velocity(1) Inversion  '
     1,' 6- Update Model (need lam)             '
     1,' 7- Plot TTim/Dispersion/Velocity Model '
     1,'                                        '
     1,' 9- Plot Resolution Kernel         '/
        data (out(i),i=11,20)/
     1 '10- List Singular Values                '
     1,'11- Ttime Data Partial Derivatives      '
     1,'12- Ttime Data                '
     1,'13- List Velocity Model (need lam)      '
     1,'14- Ttime Resolving Kernel (need lam) '
     1,'                                        '
     ...
     1,'41- Enter SigTp minimum                 '
     1,'42- Enter SigTs minimum                 '
     1,'43- Joint Weighting: 0=TTime <--> 1=SRFW' 
     1,'44-                                     '
