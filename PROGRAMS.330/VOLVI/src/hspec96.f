...
c-----
 ...
 2021   format('depths =',1pg20.6,' (',1pg20.6,')')
 2031   format('depthr =',1pg20.6,' (',1pg20.6,')')
 2041   format('     r =',1pg20.6,' tshift=',1pg20.6,' vred=',1pg20.6)
    3   format(8(1pg12.5))
...
c           For REX=10, lsrc(10) = 8, and if jsrc(8) = 1
...
c       7-RSS   8-TSS   9-ZEX   10-REX
c
c       ieqex = 1 
c       Point Forces + Explosion
c       11-ZVF  12-RVF  13-ZHF  14-RHF  15-THF  16-PEP
c       9-ZEX   10-REX (others have no meaning)
c
c       ieqex = 2
