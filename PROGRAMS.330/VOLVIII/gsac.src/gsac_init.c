...
void gsac_init(void)
{
	...
	gsac_control.cutslow[0] = 0.0;	/* this is used for velocity cut and is slowness */	
	gsac_control.cutslow[1] = 0.0;	/* this is used for velocity cut and is slowness */	
	...
	gsac_control.xlimslow[0] = 0.0;	/* this is used for velocity cut and is slowness */	
	gsac_control.xlimslow[1] = 0.0;	/* this is used for velocity cut and is slowness */	
