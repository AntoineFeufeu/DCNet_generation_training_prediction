...
printf("     mom_fac : %f\n",mom_fac);
	...
	*/
	...
	if(mt_do_z){
		...
		strncpy(sacdata[kz].sachdr.chdr[H_KSTNM], "GRN     ",9);
		strncpy(sacdata[kz].sachdr.chdr[H_KCMPNM], "BHZ     ",9);
		strncpy(sacdata[kz].schdr[H_KCMPNM], "BHZ     ",9);
		strncpy(sacdata[kz].sachdr.chdr[H_KT0], "SV      ",9);
		strncpy(sacdata[kz].sachdr.chdr[H_KT1], "-12345  ",9);
	...
	if(mt_do_r){
		...
		strncpy(sacdata[kr].sachdr.chdr[H_KSTNM], "GRN     ",9);
		strncpy(sacdata[kr].sachdr.chdr[H_KCMPNM], "BHR     ",9);
		strncpy(sacdata[kr].schdr[H_KCMPNM], "BHR     ",9);
		strncpy(sacdata[kr].sachdr.chdr[H_KT0], "SV      ",9);
		strncpy(sacdata[kr].sachdr.chdr[H_KT1], "-12345  ",9);
	...
	if(mt_do_t){
		...
		strncpy(sacdata[kt].sachdr.chdr[H_KSTNM], "GRN     ",9);
		strncpy(sacdata[kt].sachdr.chdr[H_KCMPNM], "BHT     ",9);
		strncpy(sacdata[kt].sachdr.chdr[H_KT1], "SH      ",9);
		strncpy(sacdata[kt].sachdr.chdr[H_KT0], "-12345  ",9);
		strncpy(sacdata[kt].schdr[H_KCMPNM], "BHT     ",9);
	...
	if(mt_do_n){
		...
		strncpy(sacdata[kn].sachdr.chdr[H_KSTNM], "GRN     ",9);
		strncpy(sacdata[kn].sachdr.chdr[H_KCMPNM], "BHN     ",9);
		strncpy(sacdata[kn].sachdr.chdr[H_KT1], "SV      ",9);
		strncpy(sacdata[kn].sachdr.chdr[H_KT0], "-12345  ",9);
		strncpy(sacdata[kn].schdr[H_KCMPNM], "BHN     ",9);
	...
	if(mt_do_e){
		...
		strncpy(sacdata[ke].sachdr.chdr[H_KSTNM], "GRN     ",9);
		strncpy(sacdata[ke].sachdr.chdr[H_KCMPNM], "BHE     ",9);
		strncpy(sacdata[ke].sachdr.chdr[H_KT1], "SV      ",9);
		strncpy(sacdata[ke].sachdr.chdr[H_KT0], "-12345  ",9);
		strncpy(sacdata[ke].schdr[H_KCMPNM], "BHE     ",9);
