...
struct gsac_command {
	...
	char **helper;
		...
		{PLOTSPPK, "PLOTSPPK", &gsac_set_param_psppk, &gsac_exec_psppk, help_psppk},
		{PLOTSPPK, "PSPPK", &gsac_set_param_psppk, &gsac_exec_psppk, help_psppk},
		{MAP5, "MAP5", &gsac_set_param_map5, &gsac_exec_map5, help_map5},
